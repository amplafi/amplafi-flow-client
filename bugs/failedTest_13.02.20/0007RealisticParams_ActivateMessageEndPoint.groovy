...
expect("""{"flowState": {
    ...
    "fsLookupKey": "ActivateMessageEndPoint_ci6jyqn9",
    "fsParameters": {
        "configuration": "abc",
        "user": 4,
        "broadcastProvider": 2,
