...
public class TestFlowTestDSL{
    ...
    public void setUp() throws Exception {
        dslInstance = new FlowTestDSL(null, null, true);
    }
    ...
    /**
     * Test getRequestString() method Adds "http://" before the host arg when misses.
     */
    @Test
    public void testGetRequestStringWithNoHTTPPrex(){
     //  FarReachesServiceInfo serviceInfo = new FarReachesServiceInfo("sandbox.farreach.es","8080","apiv1");
     //  dslInstance = new FlowTestDSL(serviceInfo,"",null,true);
     //  String requestString = dslInstance.getRequestStringToTest();
     //  assertEquals("http://sandbox.farreach.es:8080/c/apiv1",requestString);
    }

    /**
     * Test getRequestString() method Adds "http://" before the host arg when it exists.
     */
    @Test
    public void testGetRequestStringWithHTTPPrex(){
       // FarReachesServiceInfo serviceInfo = new FarReachesServiceInfo("http://sandbox.farreach.es","8080","apiv1");
       // dslInstance = new FlowTestDSL(serviceInfo,"",null,true);
       // String requestString = dslInstance.getRequestStringToTest();
       // assertEquals("http://sandbox.farreach.es:8080/c/apiv1",requestString);
    }
    ...
    /**
     * Test getRequestString() method Adds "http://" before the host arg.
     */
    @Test
    public void testGetRequestStringWithNoHTTPInRequestString(){
     //  String requestString = dslInstance.getRequestStringToTest();
     //  assertEquals("http://hello",requestString);
    }
     ...
     */
    @Test
    public void testGetRequestStringWithHTTPInRequestString(){
   //    String requestString = dslInstance.getRequestString();
   //    assertEquals("http://hello",requestString);
    }
