...
expect("""{
    "flowState": {
        "fsComplete": true,
        "fsLookupKey": "DraftMessages_x5ibl2ug",
        "fsParameters": {
            "configuration": "abc",
            "user": 4,
            "broadcastProvider": 2,
