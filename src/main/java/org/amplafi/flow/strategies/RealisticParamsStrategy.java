...
public class RealisticParamsStrategy extends AbstractTestingStrategy {
	...
	public void generateTestForActivity(String flow, String key,
		...
		String json = callFlowForTypicalData(requestUriString, key, flow,
				parametersPopulatedWithRealParamData);
		String json2 = callFlowForTypicalData(requestUriString, key, flow,
				parametersPopulatedWithRealParamData);
