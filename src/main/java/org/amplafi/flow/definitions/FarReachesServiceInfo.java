...
/**
 * A class which instances provide information about FarReaches service: host
 * address, port used, and API version.
 * 
...
public class FarReachesServiceInfo {
	 ...
	 *            e.g. apiv1
	 */
	public FarReachesServiceInfo(String host, String port, String path,
			String apiVersion) {
		this.host = host;
		this.port = port;
		this.path = path;
	...
	public String getRequestString() {
		...
		return addHttpPrexBeforeString(this.host) + ":" + this.port + "/"
				+ pathD + this.apiVersion;
	}
