 ...
 * @author Paul
 */
public class DSLTestGeneratorCommandLineOptions extends
	...
	public DSLTestGeneratorCommandLineOptions(String[] args)
	...
	protected Options initOptions() {
		...
		options.addOption(FLOW, true,
				"Flow name - If no know is specified tests will be generated for all flows.");
		options.addOption(STRATEGY, true,
				"One of: " + TestingStrategiesEnum.listStrategyNames());
		...
		OptionBuilder
				.withDescription("Specify query parameter name and value.");
