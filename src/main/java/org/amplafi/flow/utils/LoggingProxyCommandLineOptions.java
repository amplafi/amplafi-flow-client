 ...
 *
 */
public class LoggingProxyCommandLineOptions extends AbstractCommandLineClientOptions {
    ...
    private String getPrinter(HelpFormatter formatter){
        ...
        return newline + "Runs a logging proxy between the plugin and the wireserver.";
    }
