 ...
 * 
 */
public class LoadToolCommandLineOptions extends
	...
	protected Options initOptions() {
		...
		options.addOption(REPORT, true,
				"File to write report to. Otherwise will write to screen");
		...
		options.addOption(DURATION, true,
				"Only used with test plan. Sets the duration of each stage");
		options.addOption(NUM_THREADS, true, "Number of concurrent Threads.");
		options.addOption(FREQUENCY, true,
				"Max Frequency per thread (e.g. 100 per second) -1 is max possible.");
