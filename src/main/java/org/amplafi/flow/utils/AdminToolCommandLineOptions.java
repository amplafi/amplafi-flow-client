 ...
 * 
 */
public class AdminToolCommandLineOptions extends
	...
	protected Options initOptions() {
		...
		options.addOption(LISTDETAILED, false,
				"List In-built Scripts and show all scripts path");
	...
	private String getPrinter(HelpFormatter formatter) {
		...
		return newline
				+ "FAdmin -l : To list In-built Scripts"
				+ newline
				+ "FAdmin -L : To list In-built Scripts and show all scripts path"
				+ newline
				+ "FAdmin -x : To reset host, port, api version and key"
				+ newline
